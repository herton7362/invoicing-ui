...
const app = {
    ...
    mutations: {
        ...
        setAccessToken (state, accessToken) {
            window.localStorage.accessToken = accessToken['access_token'];
            window.localStorage.refreshToken = accessToken['refresh_token'];
            window.localStorage.expiration = new Date().getTime() + ((accessToken['expires_in'] / 2) * 1000);
        },
