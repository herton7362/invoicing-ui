    ...
    methods: {
        ...
        getContent (index) {
            ...
            switch (this.currentMessageType + index) {
                case 'unread0': mesContent = '这是你点击的《欢迎登录iView-admin后台管理系统，来了解他的用途吧》的相关内容。'; break;
                case 'unread1': mesContent = '这是你点击的《使用iView-admin和iView-ui组件库快速搭建你的后台系统吧》的相关内容。'; break;
                case 'unread2': mesContent = '这是你点击的《喜欢iView-admin的话，欢迎到github主页给个star吧》的相关内容。'; break;
                case 'hasread0': mesContent = '这是你点击的《这是一条你已经读过的消息》的相关内容。'; break;
                default: mesContent = '这是你点击的《这是一条被删除的消息》的相关内容。'; break;
            }
