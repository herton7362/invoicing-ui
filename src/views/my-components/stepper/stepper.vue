...
<script>
    import { oneOf } from 'iview/src/utils/assist.js';
    import Emitter from 'iview/src/mixins/emitter';

    const prefixCls = 'stepper';
...
//        }
    ...
    export default {
        ...
        computed: {
            ...
            innerUpClasses () {
                return `${prefixCls}-handler-up-inner ${iconPrefixCls} ${iconPrefixCls}-ios-plus-empty`;
            },
            downClasses () {
                return [
                    `${prefixCls}-handler`,
            ...
            innerDownClasses () {
                return `${prefixCls}-handler-down-inner ${iconPrefixCls} ${iconPrefixCls}-ios-minus-empty`;
            },
            inputWrapClasses () {
